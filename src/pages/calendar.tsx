  ...
  return (
    ...
    <div className="wrapper bg-white rounded shadow w-full ">
      <div className="header flex justify-between border-b p-2">
          ...
          <span className="bg-indigo-500 rounded-full text-white px-3 py-1 text-xs uppercase font-medium">Conference</span>
          <span className="bg-blue-500 rounded-full text-white px-3 py-1 text-xs uppercase font-medium">Earnings</span>
          ...
          <tr className="text-center h-20">
            ...
            <td className="border p-1 h-40 xl:w-40 lg:w-30 md:w-30 sm:w-20 w-10 overflow-auto transition cursor-pointer duration-500 ease hover:bg-gray-300">
              <div className="flex flex-col h-40 mx-auto xl:w-40 lg:w-30 md:w-30 sm:w-full w-10 mx-auto overflow-hidden">
                ...
                <div className="bottom flex-grow h-30 py-1 w-full cursor-pointer">
                  <div className="bottom flex-grow h-30 py-1 w-full cursor-pointer">
                    <div className="event bg-blue-500 text-white rounded p-1 text-sm mb-1">
                      <span className="event-name">Moderna</span>{" "}
                      <span className="time">12:00~14:00</span>
                    </div>
                    <div className="event bg-blue-500 text-white rounded p-1 text-sm mb-1">
                      <span className="event-name">Pfizer</span>{" "}
                      <span className="time">07:30~10:00</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <td className="border p-1 h-40 xl:w-40 lg:w-30 md:w-30 sm:w-20 w-10 overflow-hidden transition cursor-pointer duration-500 ease hover:bg-gray-300">
              <div className="flex flex-col h-40 mx-auto xl:w-40 lg:w-30 md:w-30 sm:w-full w-10 mx-auto overflow-hidden">
                ...
                <div className="bottom flex-grow h-30 py-1 w-full cursor-pointer">
                  <div className="event bg-yellow-500 text-white rounded p-1 text-sm mb-1">
                    <span className="event-name">BraveHeart Pharma</span>{" "}
                    <span className="time">12:00~14:00</span>
                  </div>
                </div>
              </div>
          ...
          <tr className="text-center h-20">
            ...
            <td className="border p-1 h-40 xl:w-40 lg:w-30 md:w-30 sm:w-20 w-10 overflow-auto transition cursor-pointer duration-500 ease hover:bg-gray-300">
              <div className="flex flex-col h-40 mx-auto xl:w-40 lg:w-30 md:w-30 sm:w-full w-10 mx-auto overflow-hidden">
                ...
                <div className="bottom flex-grow h-30 py-1 w-full cursor-pointer">
                  {" "}
                  <div className="event bg-indigo-500 text-white rounded p-1 text-sm mb-1">
                    <span className="event-name">CRISPR Summit</span>{" "}
